  ...
  <div class="table-box">
    ...
    >
      ...
      <template #operation="scope">
        ...
        <el-button type="info" link :icon="Notification" v-hasPermi="['sys:lead:follow']" @click="openFollowDrawer('编辑', scope.row)">跟进线索</el-button>
        <el-button type="success" link :icon="Switch" v-hasPermi="['sys:lead:toCustomer']" @click="toCustomer(scope.row.id)">转为客户</el-button>
      </template>
    </ProTable>
